...
public sealed class KnowledgeGraphDossierSectionRecordConfiguration : IEntityTypeConfiguration<KnowledgeGraphDossierSectionRecord>
{
    public void Configure(EntityTypeBuilder<KnowledgeGraphDossierSectionRecord> builder)
    {
        builder.ToTable("knowledge_graph_dossier_sections", "meta");
